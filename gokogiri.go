...
import (
	"github.com/merj/gokogiri/html"
	"github.com/merj/gokogiri/xml"
)
...
found in the github.com/merj/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
